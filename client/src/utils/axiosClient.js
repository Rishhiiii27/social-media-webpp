...
//the files we have here are not components so we have to import store here,like given below:-
import  store from "../redux/store"
    ...
    async(response)=>
    {
       store.dispatch(setLoading(false));
        ...
        if(data.status === 'ok')    
        {
            ...
            if(statusCode === 401 && !originalRequest._retry)//means access token has expired
            {
